          ...
          {features.map((feature) => (
            <li key={feature} className="flex py-2">
              <CheckIcon
                className={clsx(
                  "h-6 w-6 flex-none",
                  featured ? "text-white" : "text-purple-500"
                )}
              />
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative">
            ...
            <div
              aria-hidden="true"
              className={clsx(
                "pointer-events-none absolute inset-0 z-10 grid grid-cols-2 overflow-hidden rounded-lg bg-purple-500 transition-all duration-300",
                activePeriod === "Monthly"
